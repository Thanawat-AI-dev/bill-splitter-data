    ...
    root.innerHTML = `
      <div class="auth-shell">
        <div class="card auth-card">
          <div class="section-title">🧾 หารบิล — แอปแบ่งจ่ายบิลกับเพื่อน</div>
          <div class="section-sub">
            กรอกเมนู → เพิ่มรายชื่อเพื่อน → แชร์ลิงก์ให้แต่ละคนติ๊กเมนูของตัวเอง →
            ได้สรุปยอดพร้อมใบเสร็จ Export เก็บไว้ได้ทันที
          </div>
  ...
  "vatPercent": 0
    ...
    body.querySelector("#import-json-input").onchange = async (e) => {
      ...
      try {
        ...
        // Importing the same AI-generated file twice (an easy misstep) used
        // to duplicate every item and silently double the bill total — skip
